document.addEventListener('DOMContentLoaded', function() {
    ...
    const projetos = [
        {
            titulo: 'Calculadora',
            descricao: 'Esse projeto é uma calculadora que o usuário consegue realizar descontos e aplicar juros. Projeto em desenvolvimeto para praticar os conhecimentos  Que tecnologias usou?',
