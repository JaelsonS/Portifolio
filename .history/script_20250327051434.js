document.addEventListener('DOMContentLoaded', function() {
    ...
    const projetos = [
...

        {
            ...
            tecnologias: ['HTML', 'CSS', 'JavaScript'],
            imagem: '/img/WhatsApp Image 2025-02-25 at 06.38.22 (2).jpeg',
            linkDemo: 'jaelsons.github.io/PumPay/',
            linkCodigo: 'https://github.com/JaelsonS/PumPay'
        }
    ];
    ...
    projetos.forEach(projeto => {
        ...
        projetoCard.innerHTML = `
            <img src="${projeto.imagem}" '/img/WhatsApp Image 2025-02-25 at 06.38.22 (2).jpeg' alt="${projeto.titulo}" class="projeto-imagem">
