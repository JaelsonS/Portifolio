document.addEventListener('DOMContentLoaded', function() {
    ...
    const projetos = [
        {
            titulo: 'Calculadora',
            descricao: 'Esse projeto é uma calculadora que o usuário consegue realizar descontos e aplicar juros. Projeto em desenvolvimeto para praticar os conhecimentos adqui Que tecnologias usou?',
            tecnologias: ['HTML', 'CSS', 'JavaScript'],
            imagem: '#',
            linkDemo: '#',
            linkCodigo: 'https://jaelsons.github.io/Calculadora1/'
        },
        {
            titulo: 'Projeto 2',
            descricao: 'Descrição do segundo projeto. Foque nos desafios que enfrentou e como resolveu.',
            tecnologias: ['HTML', 'CSS', 'JavaScript'],
            imagem: 'assets/images/projeto2.jpg',
            linkDemo: '#',
            linkCodigo: 'https://github.com/seu-usuario/projeto2'
        },
        {
            titulo: 'Projeto 3',
            descricao: 'Descrição do terceiro projeto. O que aprendeu ao desenvolver este projeto?',
            tecnologias: ['HTML', 'CSS', 'JavaScript'],
            imagem: 'assets/images/projeto3.jpg',
            linkDemo: '#',
            linkCodigo: 'https://github.com/seu-usuario/projeto3'
        }
    ];
